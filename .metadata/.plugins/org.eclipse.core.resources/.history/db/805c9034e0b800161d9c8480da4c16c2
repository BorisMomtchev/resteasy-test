...
public class RestEasyTestClient {
	...
	public static void main(String[] args) {
		...
		// GET example
		ResteasyWebTarget getDummy = client.target("http://localhost:8080/test-rest/employee/99/getDummy");
        ...
        // POST example
		ResteasyWebTarget add = client.target("http://localhost:8080/test-rest/employee/add");
		Employee emp = new Employee();
		
		emp.setId(51);emp.setName("Boris");emp.setSalary(1000);
		...
		/* DELETE example
		ResteasyWebTarget delete = client.target("http://localhost:8080/test-rest/employee/50/delete");
